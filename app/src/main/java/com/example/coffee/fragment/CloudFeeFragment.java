...
public class CloudFeeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_cloudfee, container, false);
        recyclerView = view.findViewById(R.id.rev_cloudfee);
        ...
        reference.orderByChild("category").equalTo("CloudFee")
